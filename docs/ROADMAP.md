...
| 9 | Navisworks 기능군 (측정·단면·마크업·뷰포인트·물량 등) | 🔄 대부분 완료 (측정·단면 S36 · 마크업·뷰포인트 S37 · 물량 산출 S42) · 남은: 속성기반 색칠 (S15) |
...
추천 순서: **… S37·S39·S40·S41·S42 ✅ → 지금 착수가능: S43(CDE 고도화)·모바일 현장 모드·단가 DB(물량→금액)
→ S38(간섭 보고서, Word 양식 도착 시) → S15(Navisworks 잔여=속성색칠)·S17(APS 결정) → VR → S16 장비(최후)**
