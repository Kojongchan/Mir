...
| 8 | 문서·미디어 통합 뷰어 (PDF/이미지/영상/오피스/HWP, 새 탭) | 🔄 진행 (S13, PR #22) |
...
| S13 | Phase 8 · 문서/미디어 뷰어 🔄 | `feature/doc-viewers` | PDF/이미지/영상/오피스/HWP 새 탭 뷰어 (PR #22) | S12 |
...
(확장 단계 S11~S18 의 상세는 `docs/PLANNING.md`. S11·S12 완료, S13 진행(PR #22).
