...
| S42 | 5D 물량 산출·원가 연계 (Quantification) | `feature/quantities` | 카테고리/공종별 물량(개수·길이·면적·체적) 집계 → 기성/원가(0011) 연계 (§12) | 뷰어·S23 |
...
추천 순서: **… S37·S39·S40·S41 ✅ → 지금 착수가능: S42(5D 물량·원가)·S43(CDE 고도화)·모바일 현장 모드
→ S38(간섭 보고서, Word 양식 도착 시) → S15(Navisworks 잔여)·S17(APS 결정) → VR → S16 장비(최후)**
