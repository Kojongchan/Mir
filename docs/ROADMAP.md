...
| 12 | 포털 모듈 (공정현황·협업/이슈 + 게시판·기성·하도급 예정) | 🔄 진행 (S22: 공정·이슈 완료) |
...
| S22 | 포털 모듈 · 공정현황 + 협업/이슈 ✅ | `feature/portal-modules` | 공정현황(마일스톤 타임라인·S-curve·4D 링크) + 이슈/지적 트래커(0007). 남은: 게시판·기성상세·하도급 | S21 |
