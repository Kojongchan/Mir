        ...
        {monthly.length > 0 ? (
          <div className="cde-table-wrap" style={{ padding: 0, marginTop: 12 }}>
            <table className="cde-table">
              <thead><tr><th>월</th><th className="right">계획 %</th><th className="right">실적 %</th><th className="right">차이</th></tr></thead>
              <tbody>
                {monthly.map((m) => {
          ...
          <p className="muted" style={{ marginTop: 10 }}>사업개요 편집에서 월별 계획·실적을 입력하면 곡선이 그려집니다.</p>
        )}
      </section>
    </div>
  );
