...
export function ProjectNav() {
  ...
  const items: Item[] = [
    ...
    { to: `${base}/hiboard`, icon: 'hiboard', label: 'MIR Board (실시간)' },
    ...
    { to: `${base}/issues`, icon: 'issue', label: '협업 (이슈·RFI·Punch)' },
    { to: `${base}/meetings`, icon: 'meeting', label: '회의록 · 의사결정' },
    { to: `${base}/submittals`, icon: 'submittal', label: '제출물 · 승인' },
    { to: `${base}/billing`, icon: 'billing', label: '원가 · 기성' },
    { to: `${base}/assets`, icon: 'qr', label: '자재·자산 (QR)' },
    { to: `${base}/board`, icon: 'board', label: '게시판' },
    { to: `${base}/docs`, icon: 'files', label: '자료 관리' },
    { to: `${base}/members`, icon: 'members', label: '구성원·권한' },
  ];
